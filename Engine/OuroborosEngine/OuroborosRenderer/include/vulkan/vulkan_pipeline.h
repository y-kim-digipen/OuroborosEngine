...
namespace Renderer
{
	...
	struct VulkanInitializer_pipeline
	{
		...
		static VkPipelineRasterizationStateCreateInfo  PipelineRasterizationStateCreateInfo(VkPolygonMode polygon_mode, VkCullModeFlags cull_mode, bool depthbias);
	...
	inline VkPipelineRasterizationStateCreateInfo VulkanInitializer_pipeline::PipelineRasterizationStateCreateInfo(
		VkPolygonMode polygon_mode, VkCullModeFlags cull_mode, bool depthbias)
	{
		...
		pipeline_rasterization_state_create_info.depthBiasEnable = depthbias;
