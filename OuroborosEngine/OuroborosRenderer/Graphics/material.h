...
namespace Renderer {
    ...
    public:
        ...
        void InitMaterialData(const Asset::MaterialData& other);
        virtual void SetTexture(Shared::PBR_TEXTURE_TYPES type, std::shared_ptr<Texture> texture);
        virtual void Cleanup();
        Asset::MaterialData* GetMaterialData();
        int& DoUseTexture(Shared::PBR_TEXTURE_TYPES type);
        std::shared_ptr<Texture> GetTexture(Shared::PBR_TEXTURE_TYPES type);

    protected:
        std::array<std::shared_ptr<Texture>, Shared::PBR_TEXTURE_TYPES::COUNT> textures;
    ...
    inline void Material::SetTexture(Shared::PBR_TEXTURE_TYPES type, std::shared_ptr<Texture> texture)
    {
    ...
    inline std::shared_ptr<Texture> Material::GetTexture(Shared::PBR_TEXTURE_TYPES type)
    {
