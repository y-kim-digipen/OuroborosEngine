...
namespace Renderer
{
	...
	VkPipeline Vulkan_PipelineBuilder::BuildPipeLineDeferredOffscreen(VkDevice device, VkRenderPass render_pass,
		std::vector<VkPipelineShaderStageCreateInfo>& shader_stage_create_infos)
	{
        ...
        {
        VulkanInitializer::PipelineColorBlendAttachmentState(0xf, VK_FALSE),
        VulkanInitializer::PipelineColorBlendAttachmentState(0xf, VK_FALSE),
		VulkanInitializer::PipelineColorBlendAttachmentState(0xf, VK_FALSE)
        };
        ...
        color_blend_state_create_info.pAttachments = blend_attachment_states.data();
