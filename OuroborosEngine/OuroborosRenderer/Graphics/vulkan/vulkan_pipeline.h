...
namespace Renderer
{
	...
	struct Vulkan_PipelineBuilder
	{
		...
		VkPipeline BuildPipeLineDeferredOffscreen(VkDevice device, VkRenderPass render_pass, std::vector<VkPipelineShaderStageCreateInfo>& shader_stage_create_infos);
