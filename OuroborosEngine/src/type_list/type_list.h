...
namespace tl {
    ...
    {
        using type = Type;
        static constexpr uint64_t index = index_;
    };
    ...
    template<typename> struct _size_impl_inner;
    template<typename... TS> struct _size_impl_inner<type_list<TS...>>
    {
    ...
    struct type_list
    {
        ...
        static constexpr size_t size = _size_impl_inner<TS...>::value;
